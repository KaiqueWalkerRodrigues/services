...
CREATE TABLE IF NOT EXISTS `barb`.`grupos` (
  ...
  INDEX `fk_grupos_empresas_idx` (`id_empresa` ASC) ,
...
CREATE TABLE IF NOT EXISTS `barb`.`colaboradores` (
  ...
  `is_sa` TINYINT(1) NULL DEFAULT '0',
  `created_at` TIMESTAMP NOT NULL,
  `updated_at` TIMESTAMP NOT NULL,
  `deleted_at` TIMESTAMP NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `barb`.`acessos_tokens` (
  ...
  INDEX `fk_tokens_empresas_idx` (`id_empresa` ASC) ,
...
-- -----------------------------------------------------
-- Table `barb`.`colaboradores_empresas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `barb`.`colaboradores_empresas` (
  ...
  INDEX `fk_colaboradores_empresas_colaborador` (`id_colaborador` ASC) ,
  INDEX `fk_colaboradores_empresas_empresa` (`id_empresa` ASC) ,
  CONSTRAINT `fk_colaboradores_empresas_colaborador`
    FOREIGN KEY (`id_colaborador`)
    REFERENCES `barb`.`colaboradores` (`id_colaborador`)
    ON DELETE CASCADE,
  CONSTRAINT `fk_colaboradores_empresas_empresa`
    FOREIGN KEY (`id_empresa`)
    REFERENCES `barb`.`empresas` (`id_empresa`)
    ON DELETE CASCADE)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `barb`.`colaboradores_grupos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `barb`.`colaboradores_grupos` (
  ...
  INDEX `id_colaborador` (`id_colaborador` ASC) ,
  INDEX `id_grupo` (`id_grupo` ASC) ,
  INDEX `fk_colaboradores_filiais_idx` (`id_filial` ASC) ,
  CONSTRAINT `colaboradores_grupos_ibfk_1`
    FOREIGN KEY (`id_colaborador`)
    REFERENCES `barb`.`colaboradores` (`id_colaborador`)
    ON DELETE CASCADE,
  CONSTRAINT `colaboradores_grupos_ibfk_2`
    FOREIGN KEY (`id_grupo`)
    REFERENCES `barb`.`grupos` (`id_grupo`)
    ON DELETE CASCADE,
  CONSTRAINT `fk_colaboradores_filiais`
    FOREIGN KEY (`id_filial`)
    REFERENCES `barb`.`filiais` (`id_filial`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `barb`.`permissoes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `barb`.`permissoes` (
...
-- -----------------------------------------------------
-- Table `barb`.`grupos_permissoes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `barb`.`grupos_permissoes` (
  ...
  INDEX `fk_grupos_permissoes_grupos_idx` (`id_grupo` ASC) ,
  INDEX `fk_grupos_permissoes_permissoes_idx` (`id_permissao` ASC) ,
  CONSTRAINT `fk_grupos_permissoes_grupos`
    FOREIGN KEY (`id_grupo`)
    REFERENCES `barb`.`grupos` (`id_grupo`),
  CONSTRAINT `fk_grupos_permissoes_permissoes`
    FOREIGN KEY (`id_permissao`)
    REFERENCES `barb`.`permissoes` (`id_permissao`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
