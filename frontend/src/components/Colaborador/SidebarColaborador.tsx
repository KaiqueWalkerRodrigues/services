  ...
  return (
    <div className="flex flex-col gap-1">
      <button
        ...
        className="flex w-full items-center justify-between rounded-lg border-l-2 border-transparent px-3 py-2.5 text-sm text-zinc-400 transition-colors hover:bg-white/5 hover:text-zinc-200"
      >
...
export function Sidebar({
  ...
  return (
    <>
      {/* Botão Hamburguer fixo no topo (Visível apenas no mobile) */}
      ...
      >
        <div>
          ...
          {/* Espaçamento extra no mobile por causa do header fixo */}
